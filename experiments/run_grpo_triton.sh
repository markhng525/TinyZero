#!/bin/bash
# Optimized GRPO for GB10 - Triton Backend
...
# SGLang env vars for GB10 - Triton backend
...
/workspace/.venv.linux-aarch64/bin/python -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=grpo-triton-qwen2.5-1.5b-countdown \
  trainer.total_epochs=15 2>&1 | tee /workspace/experiments/logs/grpo_triton.log
