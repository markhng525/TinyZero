#!/bin/bash
# Dr. GRPO experiment for countdown task (no length normalization)
...
uv run python -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=dr_grpo-qwen2.5-1.5b-countdown \
  trainer.total_epochs=15 2>&1 | tee /workspace/experiments/logs/dr_grpo_experiment.log
